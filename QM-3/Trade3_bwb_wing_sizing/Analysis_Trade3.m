...
[rc, st, ~] = extractData(n1, "/Users/michaelchen/Documents/M-Fly/2023/QM-3/PADA_Trade3/13", true, false);
rc = cell2mat(rc);
st = cell2mat(st);
...
parameters = readtable("/Users/michaelchen/Documents/M-Fly/2023/QM-3/PADA_Trade3/QM-3_Trade3_inches.csv");
parametersMeters = readtable("/Users/michaelchen/Documents/M-Fly/2023/QM-3/PADA_Trade3/QM-3_Trade3_meters.csv");
...
%% Plot static margin with AoA < 8, statically stable, with reduced wing span 24in
AoA = [rc.alpha];
Cma = [st.Cma];
...
LD(AoA >= 8 | Cma >= 0 | staticMargin < 10 | staticMargin > 15 | wingSpan ~= 24) = NaN;
